...
import { useIntels } from "@/hooks/useIntels";

const BlogPreview: React.FC = () => {
  const { intels, loading, error } = useIntels();

  // Display only first 3 intels on homepage
  const displayIntels = loading || error ? [] : intels.slice(0, 3);
