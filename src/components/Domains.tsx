  ...
  return (
    <section id="domains" className="py-24 bg-dc-dark relative">
      <div className="max-w-7xl mx-auto px-6">
        <SectionTitle title="Core Domains" subtitle="Four pillars of technological advancement" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {DOMAINS.map((domain, index) => (
            ...
            >
              ...
              {}
              <div className={`mb-6 p-4 rounded-lg bg-black/50 w-fit border border-white/10 group-hover:border-white/40 transition-colors`}>
